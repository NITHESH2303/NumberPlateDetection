...
Main deployment script for license plate detection on images and videos
"""
...
def main(img_path=None, vid_path=None, vid_out=None):
    ...
    ### --------------- for detection on video --------------------
        ...
        out = cv2.VideoWriter('../output/output.avi', fourcc, 24.0, (640, 480))
...
# main(vid_path="../test_images/video.mp4", vid_out="../output/video1.mp4")  ### for custom video
# main(vid_path=0, vid_out="../output/webcam_result.mp4")  #### for webcam
# main(img_path="../test_img/IMG_2899.JPG")  ## for image
